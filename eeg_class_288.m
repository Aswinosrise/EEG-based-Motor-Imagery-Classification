%%%%%%%%%%%% loading data %%%%%%%%%%%%%%%%%
    ...
    %making array of matrics and changing their order
    bp = permute(reshape(bp,313,23,288),[3,1,2]); 
    %splitting the matrix into training and testing 80% and 20%
    %   eval = mat2cell(bp,[200 88],313,23);
    %   train_set=eval{1,1,1};
    %   test_set=eval{2,1,1};
    train_set = bp(1:200,:,:);
    test_set =  bp(201:end,:,:);
    ...
    %     train_table.Properties.VariableNames(1:23) = {'Ch_1','Ch_2','Ch_3','Ch_4','Ch_5','Ch_6','Ch_7','Ch_8','Ch_9','Ch_10','Ch_11','Ch_12','Ch_13','Ch_14','Ch_15','Ch_16','Ch_17','Ch_18','Ch_19','Ch_20','Ch_21','Ch_22','Class'};
    %     test_table.Properties.VariableNames(1:23)  = {'Ch_1','Ch_2','Ch_3','Ch_4','Ch_5','Ch_6','Ch_7','Ch_8','Ch_9','Ch_10','Ch_11','Ch_12','Ch_13','Ch_14','Ch_15','Ch_16','Ch_17','Ch_18','Ch_19','Ch_20','Ch_21','Ch_22','Class'};
    %
    %     %%%%%%%%%%% classification %%%%%%%%%%%%%%%
    ...
    %splitting class matrix
    train_label = c(1:200,:);
    train_label = categorical(train_label);
    test_label =  c(201:end,:);
    ...
    Msvm1 =  fitcecoc(train_set(:,:,1:22),train_label,'Coding','allpairs','Learners',t); %acc =40.7477
