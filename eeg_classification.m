...
for i=1:288
    if(h.EVENT.TYP(i)~=1023)  %wont be there just for confirmation
...
bp = bandpower(final(:,1:22),250/2,[8,9],1);

bp2 = [bp,v];

%shuffling the matrix rows
bp1 =  bp2(randperm(end),:);


%splitting the matrix into training and testing 80% and 20%
eval = mat2cell(bp1, [ceil(0.8*size(bp1,1)) ceil(0.2*size(bp1,1))-1],23);
train_set=eval{1,1};
test_set=eval{2,1};
...
train_table.Properties.VariableNames(1:23) = {'Ch_1','Ch_2','Ch_3','Ch_4','Ch_5','Ch_6','Ch_7','Ch_8','Ch_9','Ch_10','Ch_11','Ch_12','Ch_13','Ch_14','Ch_15','Ch_16','Ch_17','Ch_18','Ch_19','Ch_20','Ch_21','Ch_22','Class'};%'Ch_11'},'Ch_12','Ch_13','Ch_14','Ch_15','Ch_16','Ch_17','Ch_18','Ch_19','Ch_20','Ch_21','Ch_22','Class'};
test_table.Properties.VariableNames(1:23)  = {'Ch_1','Ch_2','Ch_3','Ch_4','Ch_5','Ch_6','Ch_7','Ch_8','Ch_9','Ch_10','Ch_11','Ch_12','Ch_13','Ch_14','Ch_15','Ch_16','Ch_17','Ch_18','Ch_19','Ch_20','Ch_21','Ch_22','Class'};%,'Ch_12','Ch_13','Ch_14','Ch_15','Ch_16','Ch_17','Ch_18','Ch_19','Ch_20','Ch_21','Ch_22','Class'};
...
t1=templateSVM('KernelFunction','rbf');
%t2=templateSVM('KernelFunction','rbf','Solver','SMO');
%t3=templateSVM('KernelFunction','polynomial','Solver','SMO');

%Mnb=fitcnb(train_table,'Class','DistributionNames','kernel');
...
Msvm1 = fitcecoc(train_table,'Class','Coding','allpairs','Learners',t1); %acc =40.7477
%Msvm2 = fitcecoc(train_table,'Class','Coding','allpairs','Learners',t2);
%Msvm3 = fitcecoc(train_table,'Class','Coding','allpairs','Learners',t3);
